	...
	<div class="contain h-100">
		...
		<div>
			...
			<div class="table-responsive mt-4 pl-5 pr-5">
				<table class="table table-striped table-bordered" id="user_table_deleted" style="margin-top: -22px;">
					<thead>
						<tr>
					...
					<tbody class="table-hover">
						...
						<tr class="table-active">
							...
							<td><?php echo htmlspecialchars($row2['firstname']) . ' ' . htmlspecialchars($row2['lastname']); ?></td>
							<td><?php echo htmlspecialchars($row2['position']); ?></td>
							<td><?php echo htmlspecialchars($row2['contact_number']); ?></td>
							<td>
								<button type="button" name="restore" title="Restore" style='font-size:10px; border-radius:5px;padding:4px;' data-id="<?php echo htmlspecialchars($row2['id']); ?>" class="restore btn btn-primary" data-toggle="#restoreModal"><i class="fas fa-recycle"></i></button>
							</td>
						</tr>
						<?php } ?>
					</tbody>
