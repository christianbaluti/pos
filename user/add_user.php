					...
					<table class="table-responsive mt-5">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="tel" name="number" pattern='\d{10}' title='Phone Number (Format: 0999999999)' class="form-control form-control-sm" placeholder="Enter Contact number" required></div></td>
							</tr>
							<tr>
