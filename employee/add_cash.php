					...
					<table class="table-responsive mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1">Mwk</span></div><input type="number" name="amount" class="form-control" placeholder="Enter Amount" required/></div></td>
							</tr>
						</tbody>
					</table>
