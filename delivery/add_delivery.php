...
<body>
	...
	<div class="contain h-100">
		...
		if($failure){
			echo '<script>swal("Unsuccesful","Supplier already exists!","error");</script>';
		}
		if($done){
			echo '<script>swal("Succesful","new Supplier added!","success");</script>';
		}
		?>
		<div>
					...
					<table class="table table-striped table-bordered table-sm">
						...
						<tr>
							<td align="right">
								...
								<b>Grand Total:&nbsp<h4 id="final_total_amount">Mwk 0.00</h4></b>
							</td>
						</tr>
					</table>
				</div>
