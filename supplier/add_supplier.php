		...
		<div class="main">
			...
			<div class="first_side ml-5 mt-5 mr-3">
				<div style="border:1px dashed black; width: 250px;height: 250px;">
					<img class="img-fluid p-2 h-100 w-100" src="../images/company.png">
				</div>
					...
					<table class="table-responsive mt-5 ">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" pattern='\d{10}' title='Phone Number (Format: 0999888777)' class="form-control-sm form-control" name="number" placeholder="Enter Conctact Number" required></div></td>
							</tr>
						</tbody>
					</table>
