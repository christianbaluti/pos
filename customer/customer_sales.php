<?php 
	...
	$sql = "SELECT sales_product.reciept_no,sales_product.price,sales_product.qty FROM customer,sales,sales_product WHERE customer.customer_id = $customer_id AND sales.customer_id = $customer_id AND sales.reciept_no = sales_product.reciept_no ORDER BY sales_product.reciept_no DESC";
			...
			<table class="table table-striped table-bordered table-sm" id="customer_table" style="margin-top: -22px;">
				...
				<tbody class="table-hover">
					...
					<tr class="table-active">
						...
						<td>
							<button type="button" name="view" style='font-size:10px; border-radius:5px;padding:4px;' id="<?php echo $customer_id;?>" class="btn btn-success btn-xs view_data"><i class="fas fa-eye"></i></button>
						</td>
					</tr>
					<?php } ?>
				</tbody>
